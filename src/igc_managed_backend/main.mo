...
actor Main {
  ...
  canisterMap.put(Principal.fromText("2vxsx-fae"), {ogcCont = null;});
  canisterMap.put(Principal.fromText("ov6n2-svkcj-ufh3m-fjwuq-x2fof-m4hoz-vl6eu-7oxbw-as6fq-dvc5u-sqe"), {ogcCont = null;}); 
  // Fixed user:
