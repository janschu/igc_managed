...
module {
    ...
    // Switch the response types
    public func getRootPage (map: TM.TrackMap, canister: Principal, local: Bool, repr: H.Representation ): Text {
        if (repr == #json) {
            return getRootJSON(map, canister, local);
        } else {
            return getRootHTML(map, canister, local);
       };
    };

    // JSON Representation
    private func getRootJSON (map: TM.TrackMap, canister: Principal, local: Bool) : Text {
        // Open
        var body : Text = "{" # JH.lb();
        // Metadata
        ...
        // Links
        body #= "\"links\": " # "[" # JH.lb();
        body #=JH.linkJSON("self", "application/json", "This document as JSON", HTTP.buildUrl("", canister, local, #json));
        body #=","#JH.lb();
        body #=JH.linkJSON("alternate", "text/html", "This document as HTML", HTTP.buildUrl("", canister, local, #html));
        body #=","#JH.lb();
        body #=JH.linkJSON("conformance", "application/json",  "Conformance as JSON", HTTP.buildUrl("/conformance", canister, local, #json));
        body #=","#JH.lb();
        body #=JH.linkJSON("conformance", "text/html",  "Conformance as HTML", HTTP.buildUrl("/conformance", canister, local, #html));
        body #=","#JH.lb();
        ...
        body #=JH.linkJSON("service-desc", "application/vnd.oai.openapi+json;version=3.0", "The OpenAPI definition as JSON", "https://ogc-api.nrw.de/inspire-lc-zfum/v1/api?f=json");
        body #=","#JH.lb();
        //body #=JH.linkJSON("service-desc", "application/json", "The OpenAPI definition as JSON", "https://m2ifq-raaaa-aaaah-abtla-cai.ic0.app/openapi.json");
        body #=JH.linkJSON("service-desc", "application/json", "The OpenAPI definition as JSON", "https://ogc-api.nrw.de/inspire-lc-zfum/v1/api?f=json");
        body #=","#JH.lb();
        ...
        body #=","#JH.lb();
        // collections
        body #=JH.linkJSON("data", "application/json",  "Collections", HTTP.buildUrl("/collections", canister, local, #json));
        body #= "]"#JH.lb();
        // collections
        // Double!
        body #= ",\"apis\": [" # JH.lb();
    ...
    private func apiJSONTrack (track : TR.Track, canister: Principal, local: Bool) : Text {
        ...
        apiJSONTrackText (
            ...
            ? metadata.trackId,
            ? HTTP.buildUrl("/collections/" # metadata.trackId, canister, local, #json),
    ...
    private func getRootHTML (map: TM.TrackMap, canister: Principal, local: Bool) : Text {
        // - Head
        ...
        navContent #= HTML.create_A("JSON", HTTP.buildUrl("", canister, local, #json), null, ?"JSON");
        // - - Header
        ...
        mainContent #= HTML.create_H3(
            HTML.create_A("Home HTML", HTTP.buildUrl("", canister, local, #html), null, ?"current"),null,null);
        mainContent #= HTML.create_Div("This Page - The landing page as HTML",null, null);
        mainContent #= HTML.create_H3(
            HTML.create_A("Home JSON", HTTP.buildUrl("", canister, local, #json), null, ?"current"),null,null);
        ...
        mainContent #= HTML.create_H3(
            HTML.create_A("Collections HTML", HTTP.buildUrl("/collections", canister, local, #html), null, null),null,null);
        mainContent #= HTML.create_Div("The Listing of all available Feature Collections - as HTML",null, null);
        mainContent #= HTML.create_H3(
            HTML.create_A("Collections JSON", HTTP.buildUrl("/collections", canister, local, #json), null, null),null,null);
        ...
        mainContent #= HTML.create_H3(
            HTML.create_A("Conformance HTML", HTTP.buildUrl("/conformance", canister, local, #html), null, null),null,null);
        mainContent #= HTML.create_Div("The conformance classes according to OGC",null, null);
        mainContent #= HTML.create_H3(
            HTML.create_A("Conformance JSON", HTTP.buildUrl("/conformance", canister, local, #json), null, null),null,null);
